          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-5">
                  <button
                    className={`relative flex items-center justify-center w-full cursor-pointer rounded-lg border p-4 text-white transition duration-300 ease-in-out ${
                      loading
                  ...
                  >
                    ...
                    <span
                      className={`flex items-center ${loading ? "ml-7" : ""}`}
                    >
